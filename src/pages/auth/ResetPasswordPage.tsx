      ...
      <div className="auth-card w-full max-w-md bg-slate-900 border border-slate-800 rounded-3xl p-8 shadow-2xl">
        ...
        {updated ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-xs font-semibold text-slate-200 mb-1">Nova senha</label>
            ...
            <div>
              <label className="block text-xs font-semibold text-slate-200 mb-1">Confirme a nova senha</label>
              <div className="relative">
                <Lock className="w-4 h-4 text-slate-400 absolute left-3.5 top-3" />
                <input
                  type="password"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 rounded-xl bg-accent hover-bg-accent text-slate-950 font-bold text-sm transition flex items-center justify-center gap-2 disabled:opacity-50"
            >
        ...
        <div className="mt-6 text-center text-xs text-slate-400">
          <Link to="/auth/login" className="text-accent font-bold hover:underline">Voltar para o login</Link>
        </div>
      </div>
    </div>
  );
